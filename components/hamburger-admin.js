export default function hamburgerAdmin() {
    return /*HTML*/ `
      ...
      <div class="hamburger-panel" id="hamburger-admin">
      ...
      <a href="/manageUser" class="hamburger-links"><span class="hamburger-text">Manage user</span> <img src="./public/icons/user-management.png" class="hamburger-icon"></a>
